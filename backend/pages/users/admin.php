...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="page-wrapper">
            ...
            class="btn btn-primary pull-right">quản lý users</a>
            <a href="http://localhost:600/project_story/backend/pages/users/index.php" 
            class="btn btn-warning pull-right">Quay về</a>
            <a href="http://localhost:600/project_story/backend/pages/users/add.php" 
            class="btn btn-success pull-right">Add admin</a>
